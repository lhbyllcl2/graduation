  ...
  <div class="profile_page">
    ...
    <section>
      <section class="profile-number">
        <router-link :to="is_login? '/profile' : '/login'" class="profile-link">
          <img :src="avatar" class="privateImage" v-if="is_login">
    ...
    <section class="exitlogin" @click="exitlogin" v-if="is_login">退出登录</section>
      ...
      initData() {
        ...
        if (token) {
          ...
          getUser().then(res => {
            ...
            this.mobile = data.mobile || '暂无绑定手机号';
            this.balance = data.balance;
            this.count = data.gift_amount;
            this.pointNumber = data.point;
          });
        } else {
          this.username = '登录/注册';
          this.mobile = '暂无绑定手机号';

    ...
    <section v-if="!showLoading" id="scroll_section" class="scroll_container">
      <section class="scroll_insert">
        <section class="food_list">
          <router-link class="food_list_header" :to="{path: '/shop'}">
            <div class="shop_name">
          ...
          <div class="pay_ment">实付{{orderDetail.total_amount}}</div>
        </section>
...
<script>
  ...
  export default {
    ...
    methods: {
      async initData() {
        await getOrderDetail(this.orderId).then(res => {
